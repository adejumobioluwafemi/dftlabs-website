...
const NAV_ITEMS = [
    ...
    { path: "/admin/blog", icon: "✍️", label: "Blog Drafts" },
    ...
    return (
        <div style={{
            ...
            <div style={{
                ...
                <h1 style={{ fontSize: 24, fontWeight: 800, color: "var(--text)", fontFamily: "var(--font-display)", marginBottom: 8 }}>
                    Admin Access
                </h1>
                <p style={{ fontSize: 14, color: "var(--text-faint)", marginBottom: 32 }}>
                    DFT Labs Internal Panel
                </p>
